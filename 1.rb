...
sum = input.sum do |line|
  first_digit = line.match(/#{regular_match}|\d/)[0]
  first_digit = mapping[first_digit] if mapping.key?(first_digit)
  last_digit = line.reverse.match(/#{reverse_match}|\d/)[0]
  last_digit = mapping[last_digit.reverse] if mapping.key?(last_digit.reverse)
